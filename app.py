...
Selective Recipient Email Dispatcher & Post-Processing Editor
"""
    ...
    if df_db_records.empty:
        ...
        selected_db_df = st.data_editor(
            ...
            column_config={
                "Send": st.column_config.CheckboxColumn(
                    "Send Email?",
                    help="Check to send email to this recipient",
                    default=True,
                ),
                "name": "Recipient Name",
                "email": "Email Address",
            ...
            disabled=["credential_id", "name", "email", "course", "issue_date"],
            hide_index=True,
            use_container_width=True,
